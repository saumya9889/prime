...
const TenthSec = () => {
  ...
  return (
    <Flex
      ...
      justify="center"
    >
      <Text textAlign="center" fontFamily="goudy" fontSize="2.125rem" mb="1.563rem">
      ...
      <SimpleGrid columns="3" gap="0.625rem" pb="0.938rem" justify="center">
        <Button
      ...
      >
        ...
        >
          <HStack w="100%" gap="3.125rem">
            ...
            <Heading w="60%" fontFamily="avenir" fontSize="1rem">
