  ...
  = ({ isOpened, onClosed }) => {
    return (
      <>
        ...
        />
        <Modal size="lg" blockScrollOnMount={true} returnFocusOnClose={false} show={isOpened} onHide={onClosed} className="enquiry-wrapper">
          <Modal.Header closeButton >
          </Modal.Header>
          <Modal.Body>
            <Flex direction="column">
              <Flex className="modal-content-grid">
                <Flex w="50%" className="modal-left-item" align="center" direction="column" gap="1rem" h="50%">
                ...
                <Flex boxShadow="2xl" className="modal-right-item" w="50%" align="center" justify="center" direction="column" pb="1rem" mt="5rem" bgImage='linear-gradient(rgba(255,255,255,.5), rgba(255,255,255,.5)), url("/images/bg-box.jpg")'
                  bgRepeat="no-repeat"
                  bgPos="center"
                  bgSize="cover">
                  <form>
